function love.load()
	...
	quads['left'] ={}
	quads["right"] ={}
	rightStopChar=love.graphics.newQuad(0, 120, 60, 60, sprite.player:getDimensions())
	leftStopChar=love.graphics.newQuad(60, 120, 60, 60, sprite.player:getDimensions())
	for i=1,8 do
