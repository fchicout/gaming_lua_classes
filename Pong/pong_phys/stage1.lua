...
function Stage:load()
  ...
  downBorder = {x = 0, y=love.graphics.getHeight()-self.xBorderHeight, width=love.graphics.getWidth(), height=self.xBorderHeight, idleColor={255,255,255}, collisionColor={}}
  ...
  leftBorder = {x = 0, y=self.xBorderHeight, width=self.yBorderWidth, height=love.graphics.getHeight()-2*self.xBorderHeight, idleColor={255,255,255}, collisionColor={}}
  ...
  rightBorder = {x = love.graphics.getWidth()-self.yBorderWidth, y = self.xBorderHeight, width=self.yBorderWidth, height=love.graphics.getHeight()-2*self.xBorderHeight, idleColor={255,255,255}, collisionColor={}}
